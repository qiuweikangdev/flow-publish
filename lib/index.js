...
import { getVersion, isGitFlowInit, getCurTag, validateVersion, pullOrigin, getPackageName } from './utils.js'

async function publish() {
  console.log(chalk.magentaBright.bold(`${getPackageName()}版本发布~`))
  $.verbose = false
