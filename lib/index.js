...
import { getVersion, isGitFlowInit, getCurTag, validateVersion, pullOrigin, getProjectName } from './utils.js'
...
async function publish() {
  ...
  try {
    ...
    // develop、master拉取最新代码，保证合并代码正常, 避免在发布版本时出现合并代码时的冲突和错误
    try {
      await pullOrigin()
      console.log(chalk.greenBright('本地develop、master分支代码已是远程最新'))
    } catch (e) {
